...
$100$ versus $4.6\cdot 10^{-4}$ for SGPTL at iteration $8000$) lines
up with what the $O(\log\varepsilon^{-1})$ versus $O(\varepsilon^{-2})$
contrast predicts: SGPTL needed roughly $3000\times$ the iteration
count IRLS used to reach $\varepsilon=10^{-2}$, and another factor
of $6\times$ to reach $10^{-3}$.
