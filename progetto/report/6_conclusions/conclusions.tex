...
where $\rho$ matters significantly and there $\rho=0.99$ slightly
outperforms the $\rho=0.9$ default ($8.5\cdot 10^{-3}$ versus
$1.7\cdot 10^{-2}$). The initial gap estimate $\delta_{0}$ is the more
sensitive parameter, with a clear failure mode at $\delta_{0}\le
0.01\,f^{*}$ (target above $f^{*}$, iterate locked) and a U-shaped
optimum at $\delta_{0}=0.1\,f^{*}$.
