...
\cite{subdifferential-introduction-frangioni}. By the sum rule for subdifferentials
\cite{subdifferential-sum-rule}, the equation above is exactly
$\mathbf{0} \in \partial f(\mathbf{w}^*)$, the optimality condition
of~\eqref{eq:irls_objective} \cite{subdifferential-introduction-frangioni}.
\end{proof}
