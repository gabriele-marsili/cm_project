...
\end{equation}
The Polyak denominator $\norm{\mathbf{d}_i}^2$ makes this the maximum-step choice. The problem is quadratic in $\gamma$ with closed-form solution \cite[Slide 15]{frangioni-slides-nonsmooth}:
